...
model = lm(r"Stock Predictions Model 2025.keras")
...
model1=lm(r'Stock Predictions Model longterm 2025.keras')
...
model2=lm(r'Stock extremes 2025.keras')
...
model3=lm(r'Stock days 2025.keras')
